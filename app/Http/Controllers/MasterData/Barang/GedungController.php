...
class GedungController extends Controller {
    ...
    public function index(Request $request){
        ...
        return view('admin.master.barang.gedung_bangunan.gedung', compact('nmAset5','kd_aset','text'));
    ...
    public function detail($id){
        ...
        ->join('ref_rek5_108 as b' , function($join)
        {
            ...
            ->where('id',$id)->first(); 
            return view('admin.master.barang.gedung_bangunan.detail', compact('gedung'));

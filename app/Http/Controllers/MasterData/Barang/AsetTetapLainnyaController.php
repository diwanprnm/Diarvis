...
class AsetTetapLainnyaController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('admin.master.barang.aset_tetap_lainnya.asettetaplainnya', compact('nmAset5','kd_aset','text'));
    ...
    public function json()
    {
        ...
        $atl = DB::table('ta_fn_kib_e')
                    ->select('id','tahun',DB::raw("CONCAT(ta_fn_kib_e.kd_aset,'',ta_fn_kib_e.kd_aset0,'',ta_fn_kib_e.kd_aset1,'',ta_fn_kib_e.kd_aset2,'',ta_fn_kib_e.kd_aset3,'',ta_fn_kib_e.kd_aset4,'',ta_fn_kib_e.kd_aset5) as kode_aset"), 
                       'no_register', 'kd_ruang', 'kd_pemilik',DB::raw(" to_char( tgl_perolehan, 'DD-MM-YYYY') as tgl_perolehan"), DB::raw(" to_char( tgl_pembukuan, 'DD-MM-YYYY') as tgl_pembukuan"), DB::raw(" to_char( tgl_dokumen, 'DD-MM-YYYY') as tgl_dokumen"),'bahan', 'ukuran', 'asal_usul', 
                        'harga', 'masa_manfaat', 'nilai_sisa' )
                        ->where('kd_ka','1');
    ...
    public function detail($id) {
        ...
        ->join('ref_rek5_108 as b' , function($join)
        {
            ...
            ->where('id',$id)->first(); 
            return view('admin.master.barang.aset_tetap_lainnya.detail', compact('atl'));
    }
    ...
    public function save(Request $request)
    {
        ...
        // dd($request->kondisi);
        $atl['kd_pemilik'] = $request->kd_pemilik;
        ...
        $atl['kd_aset0'] = $request->kd_aset_0;
        $atl['kd_aset1'] = $request->kd_aset_1;
        $atl['kd_aset2'] = $request->kd_aset_2;
        $atl['kd_aset3'] = $request->kd_aset_3;
        $atl['kd_aset4'] = $request->kd_aset_4;
        $atl['kd_aset5'] = $request->kd_aset_5;
        $atl['no_register'] = $request->no_reg;

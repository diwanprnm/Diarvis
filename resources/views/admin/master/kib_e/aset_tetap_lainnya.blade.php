    ...
    <div class="col-lg-4">
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="#">KIB-E</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-panel">
        ...
        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
            <div class="accordion-content accordion-desc">
                <form action="{{route('getAsetTetapLainnyaFilter')}}" method="post">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input name="judul" id="edit_judul" value="{{$filter['judul']}}" type="text" class="form-control"  >
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-block">
                ...
                <a  href="{{route('aset-tetap-lainnya.add')}}" class="btn btn-sm btn-round btn-primary mb-3"><i class="icofont icofont-plus-circle"></i> Tambah Aset Tetap Lainnya (KIB E)</a>
                @endif
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttable').DataTable({
            ...
            ajax: {
                ...
                data: {
                    "judul" : "{{ !empty($filter['judul']) ? $filter['judul'] : ""  }}"
                }
            },

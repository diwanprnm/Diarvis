        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#!">Aset Tetap Lainnya</a>
                    </li>
                </ul>
            </div>
        </div>
...
@section('page-body')
    <form action="{{ route('aset-tetap-lainnya.update') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <form action="{{ route('aset-tetap-lainnya.update') }}" method="post">
                            ...
                            <input type="hidden" name="idpemda" value="{{ $aset->id }} " />
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select name="kode_pemilik" id="kode_pemilik" class="form-control chosen-select">
                                        ...
                                        @foreach ($kode_pemilik as $data)
                                            <option {{ $data->kd_pemilik == $aset->kd_pemilik ? 'Selected' : '' }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="col separated-input d-flex row">
                                        <input type="text" id="kd_aset" name="kd_aset" value="{{ $aset->kd_aset8 }}"
                                            class="form-control" style="width:40px" placeholder="...">
                                        <input type="text" id="kd_aset0" name="kd_aset0" value="{{ $aset->kd_aset80 }}"
                                            class="form-control" style="width:40px" placeholder="...">
                                        <input type="text" id="kd_aset1" name="kd_aset1" value="{{ $aset->kd_aset81 }}"
                                            class="form-control" style="width:40px" placeholder="...">
                                        <input type="text" id="kd_aset2" name="kd_aset2" value="{{ $aset->kd_aset82 }}"
                                            class="form-control" style="width:40px" placeholder="...">
                                        <input type="text" id="kd_aset3" name="kd_aset3" value="{{ $aset->kd_aset83 }}"
                                            class="form-control" style="width:40px" placeholder="...">
                                        <input type="text" id="kd_aset4" name="kd_aset4" value="{{ $aset->kd_aset84 }}"
                                            class="form-control" style="width:40px" placeholder="...">
                                        <input type="text" id="kd_aset5" name="kd_aset5" value="{{ $aset->kd_aset85 }}"
                                            class="form-control" style="width:40px" placeholder="...">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" value="{{ $aset->no_register }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control fill" value="{{ $aset->tgl_perolehan }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" value="{{ $aset->tgl_pembukuan }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="judul" type="text" value="{{$aset->judul}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Pencipta</label>

                                <div class="col-sm-9">
                                    <input class="form-control" name="pencipta" type="text" value="{{$aset->pencipta}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="bahan" type="text" value="{{$aset->bahan}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="ukuran" type="text" value="{{$aset->ukuran}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="masa_manfaat" type="number" value="{{$aset->masa_manfaat}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="nilai_sisa" type="number" value="{{$aset->nilai_sisa}}">
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <option></option>
                            <option {{  ($aset->asal_usul == "Pembelian") ? "Selected" :"" }} value="Pembelian">Pembelian</option>
                            <option {{  ($aset->asal_usul == "Hibah") ? "Selected" :"" }} value="Hibah">Hibah</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <textarea class="form-control" name="keterangan">{{ $aset->keterangan}}</textarea> 
                        </div>
                    </div>     
                    <div class="form-group row">
                        ...
                        <select name="kab_kota" id="kab_kota" class="form-control chosen-select">
                            <option>-</option>
                                ...
                                <option {{ ($aset->kd_kab_kota == $data->kode_kab_kota) ? "selected" :""  }} value="{{ $data->kode_kab_kota }}">{{ $data->nama_kab_kota }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>   
                    <div class="form-group row">
                        ...
                        <option>-</option>
                                ...
                                <option {{ ($aset->kd_kecamatan == $data->kode_kecamatan) ? "selected" :""  }} value="{{ $data->kode_kecamatan }}">{{ $data->nama_kecamatan }}</option>
                                @endforeach
                            </select>
                             </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        @foreach ($desa as $data)
                                <option {{ ($aset->kd_desa == $data->kode_desa) ? "selected" :""  }} value="{{ $data->kode_desa }}">{{ $data->nama_desa }}</option>
                                @endforeach
                             </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <select name="rincian_obyek" id="rincian_obyek" class="form-control chosen-select">
                                ...
                                @foreach ($rincian_object as $data)
                                    <option
                                        {{ $aset->kd_aset81 . '_' . $aset->kd_aset83 == $data->kd_aset1 . '_' . $data->kd_aset3 ? 'selected' : '' }}
                            ...
                            <select name="sub_rincian_obyek" id="sub_rincian_obyek" class="form-control chosen-select">
                                @if (!empty($sub_rincian_obyek))
                                    @foreach ($sub_rincian_obyek as $data)
                                        <option
                                            {{ $aset->kd_aset81 . '_' . $aset->kd_aset84 == $data->kd_aset1 . '_' . $data->kd_aset4 ? 'selected' : '' }}
                                            value="{{ $data->kd_aset1 . '_' . $data->kd_aset4 }}">{{ $data->nm_aset4 }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <select name="sub_sub_rincian_obyek" id="sub_sub_rincian_obyek"
                                ...
                                @if (!empty($sub_sub_rincian_obyek))
                                    @foreach ($sub_sub_rincian_obyek as $data)
                                        {{ $kd_aset8 =$aset->kd_aset8 .'_' .$aset->kd_aset80 .'_' .$aset->kd_aset81 .'_' .$aset->kd_aset82 .'_' .$aset->kd_aset83 .'_' .$aset->kd_aset84 .'_' .$aset->kd_aset85 }}

...
<div class="row align-items-end">
    <div class="col-lg-8">
        <div class="page-header-title">
            <div class="d-inline">
                <h4>Jalan, Irigasi, dan Lainnya (KIB D)</h4>
                <span></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-block">
                ...
                <a  href="{{route('jalan.add')}}" class="btn btn-sm btn-round btn-primary mb-3"><i class="icofont icofont-plus-circle"></i> Tambah Jalan, Irigasi, dan Lainnya (KIB D)</a>
                @endif
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#dttable').DataTable({
            ...
            bFilter: false,
            ajax: {
                url: "{{ url('admin/master-data/barang/intra/jalan/json') }}",

...
@section('title') Jalan, Irigasi, dan Lainnya (KIB D) @endsection
@section('head')
...
<div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4> Edit Data Jalan, Irigasi KIB/D</h4>
                                                    <span></span>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form action="{{route('jalan.save')}}" method="post">
                        @csrf 
                        ...
                        <select name="unit" id="unit" class="form-control chosen-select">
                                <option>-</option>
                                    ...
                                    <option value="{{ $jalan->unit }}">{{ $data->nama_unit }}</option>
                                    @endforeach
                                </select> 
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">Tgl. Dokumen</label>
   
                        <div class="col-sm-6">
                        <input class="form-control" name="tanggal_dokumen" type="date">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                        <input class="form-control" name="no_dokumen" type="text">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="hak_tanah" id="asal_usul" class="form-control"  >
                            <option></option>
                            <option value="Pembelian">Baik</option>
                            <option value="Hibah">Buruk</option>
                            </select>
                        </div>
                    </div>

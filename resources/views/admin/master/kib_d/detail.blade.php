...
<div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4>  {{$jalan->nm_aset5}}</h4>
                                                    <span>Kode {{ $jalan->kode_aset}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                                                ...
                                                                <div class="media-body row">
                                                                    <div class="col-lg-12">
                                                                        <div class="user-title">
                                                                            <h2>{{$jalan->nm_aset5}}</h2>
                                                                            <span class="text-white">{{$jalan->lokasi}}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                                            ...
                                                                                            <table class="table table-striped   nowrap">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>{{$jalan->kd_pemilik}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Kode Aset</th>
                                                                                                        <td>{{$jalan->kode_aset}}<br/>
                                                                                                        <b>{{$jalan->nm_aset5}}</b>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">No Register</th>
                                                                                                        <td>{{$jalan->no_register}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Tgl Pembelian</th>
                                                                                                        <td>{{$jalan->tgl_perolehan}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Tgl Pembukuan</th>
                                                                                                        <td>{{$jalan->tgl_pembukuan}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                            ...
                                                                                            <table class="table table-striped   nowrap">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>{{$jalan->masa_manfaat}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Nilai Sisa</th>
                                                                                                        <td>{{$jalan->nilai_sisa}}</td>
                                                                                                    </tr>
                                                                                                    <tr>

...
<div class="row align-items-end">
    <div class="col-lg-8">
        <div class="page-header-title">
            <div class="d-inline">
                <h4>Edit Data Peralatan dan Mesin KIB/B</h4>
                <span></span>
            </div>
        </div>
    </div>
...
@section('page-body')
<form action="{{route('peralatan.update')}}" method="post"  enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-block">
                    <input type="hidden" name="idpemda" value="{{ $peralatan->id }} " />
                    <input type="hidden" name="upb_val" id="upb_val" value="{{ $peralatan->kd_bidang.'_'.$peralatan->kd_unit.'_'.$peralatan->kd_sub.'_'.$peralatan->kd_upb }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <option>-</option>
                                ...
                                <option {{ ($data->kd_pemilik == $peralatan->kd_pemilik) ? "Selected" :"" }} value="{{ $data->kd_pemilik }}">{{ $data->kd_pemilik }} {{ $data->nm_pemilik }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="col separated-input d-flex row" style="padding: 0px !important; margin: 0px !important;">
                                <input type="text" id="kd_aset" name="kd_aset" value="{{ $peralatan->kd_aset8 }}" class="form-control" style="width:40px"
                                    placeholder="...">
                                <input type="text" id="kd_aset0" name="kd_aset0" value="{{ $peralatan->kd_aset80 }}" class="form-control" style="width:40px"
                                    placeholder="...">
                                <input type="text" id="kd_aset1" name="kd_aset1" value="{{ $peralatan->kd_aset81 }}" class="form-control" style="width:40px"
                                    placeholder="...">
                                <input type="text" id="kd_aset2" name="kd_aset2" value="{{ $peralatan->kd_aset82 }}" class="form-control" style="width:40px"
                                    placeholder="...">
                                <input type="text" id="kd_aset3" name="kd_aset3" value="{{ $peralatan->kd_aset83 }}" class="form-control" style="width:40px"
                                    placeholder="...">
                                <input type="text"  id="kd_aset4" name="kd_aset4" value="{{ $peralatan->kd_aset84 }}" class="form-control" style="width:40px"
                                    placeholder="...">
                                <input type="text" id="kd_aset5" name="kd_aset5" value="{{ $peralatan->kd_aset85 }}" class="form-control" style="width:40px"
                                    placeholder="...">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control"value="{{ $peralatan->no_register }}" name="no_register"  id="no_register" readonly >
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control fill" value="{{ substr($peralatan->tgl_perolehan, 0, 10) }}" name="tanggal_pembelian" type="date">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" value="{{ substr($peralatan->tgl_pembukuan, 0, 10) }}" name="tanggal_pembukuan" type="date">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="merk" value="{{ $peralatan->merk }}" type="text" placeholder="Masukkan Merk . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="type" value="{{ $peralatan->type }}" type="text" placeholder="Masukkan Type . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="cc" value="{{ $peralatan->cc }}" type="text" placeholder="Masukkan CC . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="bahan" id="bahan" value="{{ $peralatan->bahan }}" type="text" placeholder="Masukkan Bahan">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="no_pabrik" value="{{ $peralatan->nomor_pabrik }}" id="no_pabrik" type="text" placeholder="Masukkan No Pabrik . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="no_rangka" value="{{ $peralatan->nomor_rangka }}" id="no_rangka" type="text" placeholder="Masukkan No Rangka . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="no_mesin" value="{{ $peralatan->nomor_mesin }}" id="no_mesin" type="text" placeholder="Masukkan No Mesin . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="no_bpkb" value="{{ $peralatan->nomor_bpkb }}" id="no_bpkb" type="text" placeholder="Masukkan No BPKB . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="no_polisi" value="{{ $peralatan->nomor_polisi }}" id="no_polisi" type="text" placeholder="Masukkan No Polisi . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="asal_usul" id="asal_usul" class="form-control chosen-select">
                                ...
                                <option {{ ($peralatan->asal_usul == "Pembelian") ? "Selected" : "" }} value="Pembelian">Pembelian</option>
                                <option {{ ($peralatan->asal_usul == "Hibah") ? "Selected" : "" }} value="Hibah">Hibah</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="kondisi" id="kondisi" class="form-control chosen-select">
                                ...
                                <option {{ ($peralatan->kondisi == 1) ? "Selected" : "" }} value="1">Baik</option>
                                <option {{ ($peralatan->kondisi == 0) ? "Selected" : "" }} value="0">Rusak</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="harga" value="{{ intval($peralatan->harga) }}" id="harga" type="number" placeholder="Masukkan Harga . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-vertical">
                        ...
                        <div class="col-md-6">
                            <input type="number" class="form-control" name="masa_manfaat" value="{{ intval($peralatan->masa_manfaat) }}" id="masa_manfaat" placeholder="Masukkan Masa Manfaat . . .">
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="nilai_sisa" value="{{ intval($peralatan->nilai_sisa) }}" id="nilai_sisa" type="number" placeholder="Masukkan Nilai Sisa . . .">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Masukkan Keterangan . . .">{{ $peralatan->keterangan }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select name="kab_kota" id="kab_kota" class="form-control chosen-select">
                                ...
                                @foreach ($kab_kota as $data)
                                    <option {{ ($peralatan->kd_kab_kota == $data->kode_kab_kota) ? "selected" :""  }} value="{{ $data->kode_kab_kota }}">{{ $data->nama_kab_kota }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="kecamatan" id="kecamatan" class="form-control chosen-select">
                                ...
                                @foreach ($kecamatan as $data)
                                    <option {{ ($peralatan->kd_kecamatan == $data->kode_kecamatan) ? "selected" :""  }} value="{{ $data->kode_kecamatan }}">{{ $data->nama_kecamatan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="desa" id="desa" class="form-control chosen-select">
                                @foreach ($desa as $data)
                                    <option {{ ($peralatan->kd_desa == $data->kode_desa) ? "selected" :""  }} value="{{ $data->kode_desa }}">{{ $data->nama_desa }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select name="rincian_obyek" id="rincian_obyek" class="form-control chosen-select">
                            ...
                            <option {{ (($peralatan->kd_aset81."_".$peralatan->kd_aset83) ==  ($data->kd_aset1.'_'.$data->kd_aset3)) ? "selected" : "" }} value="{{ $data->kd_aset1.'_'.$data->kd_aset3}}">{{ $data->nm_aset3 }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                        ...
                        <select name="sub_rincian_obyek" id="sub_rincian_obyek" class="form-control chosen-select">
                            @if(!empty($sub_rincian_obyek))
                                @foreach ($sub_rincian_obyek as $data)
                                    <option {{ (($peralatan->kd_aset81."_".$peralatan->kd_aset84) ==  ($data->kd_aset1.'_'.$data->kd_aset4)) ? "selected" : "" }} value="{{ $data->kd_aset1.'_'.$data->kd_aset4}}">{{ $data->nm_aset4 }}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                            ...
                            class="form-control chosen-select">
                                @if(!empty($sub_sub_rincian_obyek))
                                    @foreach ($sub_sub_rincian_obyek as $data)
                                        {{ $kd_aset8 = $peralatan->kd_aset8.'_'.$peralatan->kd_aset80.'_'.$peralatan->kd_aset81.'_'.$peralatan->kd_aset82.'_'.$peralatan->kd_aset83.'_'.$peralatan->kd_aset84.'_'.$peralatan->kd_aset85  }}

                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="media-left">
                                                                    <a href="#" class="profile-image">
                                                                        <img class="user-img img-radius" src="\assets\images\rusun.jpg" style="width:108px;height:108px" alt="user-img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body row">
                                                                    <div class="col-lg-12">
                                                                        <div class="user-title">
                                                                            ...
                                                                            <span class="text-white">{{$gedung->lokasi}}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                                            ...
                                                                                            <table class="table table-striped   nowrap">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>{{$gedung->tgl_pembukuan}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Bertingkat Tidak</th>
                                                                                                        <td>{{$gedung->bertingkat_tidak}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                        ...
                                                                                        <div class="table-responsive">
                                                                                            <table class="table table-striped   nowrap">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <th scope="row">Kode Tanah</th>
                                                                                                        <td>{{$gedung->kode_tanah}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>{{$gedung->masa_manfaat}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Nilai Sisa</th>
                                                                                                        <td>{{$gedung->nilai_sisa}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#dttable').DataTable({
            ...
            bFilter: false,
            ajax: {
                url: "{{ url('admin/master-data/barang/intra/gedung/json') }}",

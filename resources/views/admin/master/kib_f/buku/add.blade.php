...
@section('title') Data Buku (KIB F) @endsection
@section('head')
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Buku</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
{{-- 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="kondisi" id="kondisi" type="number" class="form-control chosen-select">
                            <option></option>
                            <option type="number"  value="1">Baik</option>
                            <option type="number" value="2">Kurang Baik</option>
                            <option type="number" value="3">Buruk</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input class="form-control" name="dokumen_nomor" type="number">
                        </div>
                    </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="loader_kib_a" style="display:none">
                                                        <div class="progress">
                                                         ...
                                                         <table  class="table table-striped table-bordered able-responsive" id="table_kib_f">
                                                            <thead>
                                                                <tr>
                                                                    <th>No. Reg</th>
                                                                    <th>Tgl Perolehan</th>
                        ...
                        <div class="form-group row">
                            ...
                            <select name="rincian_obyek" id="rincian_obyek" class="form-control chosen-select">
                                    <option>-</option>
                                        ...
                                        <option value="{{ $data->kd_aset0.'_'.$data->kd_aset1}}">{{ $data->nm_aset3 }}</option>
                                        @endforeach
                                    </select> 
                            </div>
                        </div>

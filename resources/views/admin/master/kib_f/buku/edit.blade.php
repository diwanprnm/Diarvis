                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="geBuku">Buku</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form action="{{route('buku.update')}}" method="post">
                     ...
                     <input type="hidden" name="idpemda" value="{{ $buku->id }} " />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <option>-</option>
                                ...
                                <option {{ ($data->kd_pemilik == $buku->kd_pemilik) ? "Selected" :"" }} value="{{ $data->kd_pemilik }}">{{ $data->kd_pemilik }} {{ $data->nm_pemilik }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col separated-input d-flex row">
                            <input type="text" id="kd_aset" name="kd_aset" value="{{ $buku->kd_aset8 }}"   class="form-control" style="width:40px"
                                placeholder="...">
                            <input type="text" id="kd_aset0" name="kd_aset0" value="{{ $buku->kd_aset80 }}" class="form-control" style="width:40px"
                                placeholder="...">
                            <input type="text" id="kd_aset1" name="kd_aset1" value="{{ $buku->kd_aset81 }}" class="form-control" style="width:40px"
                                placeholder="...">
                            <input type="text" id="kd_aset2" name="kd_aset2" value="{{ $buku->kd_aset82 }}" class="form-control" style="width:40px"
                                placeholder="...">
                            <input type="text" id="kd_aset3" name="kd_aset3" value="{{ $buku->kd_aset83 }}" class="form-control" style="width:40px"
                                placeholder="...">
                            <input type="text"  id="kd_aset4" name="kd_aset4" value="{{ $buku->kd_aset84 }}" class="form-control" style="width:40px"
                                placeholder="...">
                            <input type="text" id="kd_aset5" name="kd_aset5" value="{{ $buku->kd_aset85 }}" class="form-control" style="width:40px"
                                placeholder="...">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="number" class="form-control"value="{{ $buku->no_register }}" name="no_register"  id="no_register" readonly >
                        </div>
                        <div class="col-sm-3">
                            <p><i>(Otomatis)</i></p>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input class="form-control fill" value="{{ $buku->tgl_perolehan}}" name="tanggal_pembelian" type="date">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input class="form-control" value="{{ $buku->tgl_pembukuan}}" name="tanggal_pembukuan" type="date">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input class="form-control" value="{{ $buku->dokumen_tanggal }}" name="tanggal_dokumen" type="date">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">No Dokumen</label>
   
                        <div class="col-sm-9">
                        <input class="form-control" value="{{ $buku->dokumen_nomor}}" name="no_dokumen" type="text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <option></option>
                            <option {{  ($buku->asal_usul == "Pembelian") ? "Selected" :"" }} value="Pembelian">Pembelian</option>
                            <option {{  ($buku->asal_usul == "Hibah") ? "Selected" :"" }} value="Hibah">Hibah</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <textarea class="form-control" name="keterangan">{{ $buku->keterangan}}</textarea> 
                        </div>
                    </div>     
                    <div class="form-group row">
                        ...
                        <select name="kab_kota" id="kab_kota" class="form-control chosen-select">
                            <option>-</option>
                                ...
                                <option {{ ($buku->kd_kab_kota == $data->kode_kab_kota) ? "selected" :""  }} value="{{ $data->kode_kab_kota }}">{{ $data->nama_kab_kota }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>   
                    <div class="form-group row">
                        ...
                        <option>-</option>
                                ...
                                <option {{ ($buku->kd_kecamatan == $data->kode_kecamatan) ? "selected" :""  }} value="{{ $data->kode_kecamatan }}">{{ $data->nama_kecamatan }}</option>
                                @endforeach
                            </select>
                             </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        @foreach ($desa as $data)
                                <option {{ ($buku->kd_desa == $data->kode_desa) ? "selected" :""  }} value="{{ $data->kode_desa }}">{{ $data->nama_desa }}</option>
                                @endforeach
                             </select>
                        </div>
                    </div>                                    
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="mapLatLong" class="full-map mb-2" style="height: 300px; width: 100%"></div>
                                                                        Lat <input id="lat" name="lat" type="text" value="{{ $buku->latitude}}"  class="form-control formatLatLong fill" required="">
                                                                        Long <input id="long" name="lng" type="text" value="{{ $buku->longitude}}" class="form-control formatLatLong fill" required="">     
            ...
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <select name="rincian_obyek" id="rincian_obyek" class="form-control chosen-select">
                                    <option>-</option>
                                        ...
                                        <option {{ (($buku->kd_aset81."_".$buku->kd_aset83) ==  ($data->kd_aset1.'_'.$data->kd_aset3)) ? "selected" : "" }} value="{{ $data->kd_aset1.'_'.$data->kd_aset3}}">{{ $data->nm_aset3 }}</option>
                                        @endforeach
                                    </select> 
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <option  {{ (($buku->kd_aset81."_".$buku->kd_aset84) ==  ($data->kd_aset1.'_'.$data->kd_aset4)) ? "selected" : "" }} value="{{ $data->kd_aset1.'_'.$data->kd_aset4}}">{{ $data->nm_aset4 }}</option> 
                            @endforeach
                            @endif   
                        </select> 
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ $kd_aset8 = $buku->kd_aset8.'_'.$buku->kd_aset80.'_'.$buku->kd_aset81.'_'.$buku->kd_aset82.'_'.$buku->kd_aset83.'_'.$buku->kd_aset84.'_'.$buku->kd_aset85  }}
...
<script>
    $(document).ready(function() {
        ...
        $('#table_kib_f').dataTable( {
        "bInfo": false
        } );
        $('#unit').on('change', function() {
       
            $.ajax({ 
            url: "{{route('buku.sub-unit')}}",
            method: 'POST',
            headers: {
        ...
        $('#upb').on('change', function() {
                ...
                $.ajax({ 
                url: "{{route('buku.upb.filter.table')}}",
                method: 'POST',
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
  ...
  $('#table_kib_a').each(function() {
      ...
      dt.fnDraw();
        ...
        $('#rincian_obyek').on('change', function()  {
            $.ajax({ 
                url: "{{route('buku.sub-rincian-obyek')}}",
                method: 'POST',
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
        ...
        $('#sub_rincian_obyek').on('change', function()  {
            $.ajax({ 
                url: "{{route('buku.sub-sub-rincian-obyek')}}",
                method: 'POST',
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },

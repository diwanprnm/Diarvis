    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-block">
                ...
                <a  href="{{ route('buku.add') }}" class="btn btn-sm btn-round btn-primary mb-3"><i class="icofont icofont-plus-circle"></i> Tambah Buku (KIB F)</a>
                @endif
...
<script>
    ...
    $('#delModal').on('show.bs.modal', function(event) {
        ...
        const id = link.data('id');
        console.log(id);
        const url = `{{ url('admin/master-data/barang/intra/buku/delete') }}/` + id;
        console.log(url);
        const modal = $(this);

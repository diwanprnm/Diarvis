        ...
        <div class="accordion-panel">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                <div class="accordion-content accordion-desc">
                    <form action="{{ route('getKebudayaan') }}" method="post">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input name="id_pemda" id="id_pemda"
                                                value="{{ !empty($filter['id_pemda']) ? $filter['id_pemda'] : '' }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="col separated-input d-flex row">
                                                <input type="text" id="kd_aset" name="kd_aset"
                                                    value="{{ !empty($filter['kd_aset']) ? $filter['kd_aset'] : '' }}"
                                                    class="form-control" style="width:40px" placeholder="...">
                                                <input type="text" id="kd_aset0" name="kd_aset0"
                                                    value="{{ !empty($filter['kd_aset0']) ? $filter['kd_aset0'] : '' }}"
                                                    class="form-control" style="width:40px" placeholder="...">
                                                <input type="text" id="kd_aset1" name="kd_aset1"
                                                    value="{{ !empty($filter['kd_aset1']) ? $filter['kd_aset1'] : '' }}"
                                                    class="form-control" style="width:40px" placeholder="...">
                                                <input type="text" id="kd_aset2" name="kd_aset2"
                                                    value="{{ !empty($filter['kd_aset2']) ? $filter['kd_aset2'] : '' }}"
                                                    class="form-control" style="width:40px" placeholder="...">
                                                <input type="text" id="kd_aset3" name="kd_aset3"
                                                    value="{{ !empty($filter['kd_aset3']) ? $filter['kd_aset3'] : '' }}"
                                                    class="form-control" style="width:40px" placeholder="...">
                                                <input type="text" id="kd_aset4" name="kd_aset4"
                                                    value="{{ !empty($filter['kd_aset4']) ? $filter['kd_aset4'] : '' }}"
                                                    class="form-control" style="width:40px" placeholder="...">
                                                <input type="text" id="kd_aset5" name="kd_aset5"
                                                    value="{{ !empty($filter['kd_aset5']) ? $filter['kd_aset5'] : '' }}"
                                                    class="form-control" style="width:40px" placeholder="...">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input name="f_no_register" id="f_no_register" value=" " type="number"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <input name="f_from_tgl_pembelian" id="f_from_tgl_pembelian" value=""
                                                placeholder="Dari" type="date" class="form-control">
                                        </div>
                                        <div class="col-md-4">
                                            <input name="f_to_tgl_pembelian" id="f_to_tgl_pembelian" value="" type="date"
                                                placeholder="Hingga" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Tanggal Pembukuan</label>
                                        <div class="col-md-4">
                                            <input name="f_from_tgl_pembukuan" id="f_from_tgl_pembukuan" value=""
                                                placeholder="Dari" type="date" class="form-control">
                                        </div>
                                        <div class="col-md-4">
                                            <input name="f_to_tgl_pembukuan" id="f_to_tgl_pembukuan" value="" type="date"
                                                placeholder="Hingga" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input name="f_no_sertifikat" type="text" id="f_no_sertifikat"
                                                class="form-control">
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-sm btn-round btn-info mb-3"><i
            ...
            <div class="card">
                <div class="card-block">
                    @if (hasAccess(Auth::user()->role_id, 'Unit', 'Create'))
                        <a href="{{ route('kebudayaan.add') }}" class="btn btn-sm btn-round btn-primary mb-3"><i
                                class="icofont icofont-plus-circle"></i> Tambah Kebudayaan (KIB F)</a>
                    @endif
...
@section('script')
    ...
    <script>
        ...
        var table = $('#dttable').DataTable({
            ...
            bFilter: false,
            ajax: {
                url: "{{ url('admin/master-data/barang/intra/kebudayaan') }}",
                data: function(d) {
        ...
        @if (hasAccess(Auth::user()->role_id, 'Unit', 'Delete'))
            $('#delModal').on('show.bs.modal', function(event) {
                ...
                const id = link.data('id');
                console.log(id);
                const url = `{{ url('admin/master-data/barang/intra/kebudayaan/delete') }}/` + id;
                console.log(url);
                const modal = $(this);

    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                <div class="d-inline">
                    <h4> {{ $kebudayaan->nm_aset5 }}</h4>
                    <span>Kode {{ $kebudayaan->kode_aset }}</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
                            ...
                            <div class="media-body row">
                                <div class="col-lg-12">
                                    <div class="user-title">
                                        <h2>{{ $kebudayaan->nm_aset5 }}</h2>
                                        <span class="text-white">{{ $kebudayaan->lokasi }}</span>
                                    </div>
                                </div>
                                <div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-xl-6">
                                                    <div class="table-responsive">
                                                        <h4> Informasi Detil KIB-F </h4>
                                                        <table class="table table-striped nowrap">
                                                            <tbody>
                                                                <tr>
                                                                    <th scope="row">Kode Pemilik</th>
                                                                    <td>{{ $kebudayaan->kd_pemilik . ' ' . $kebudayaan->nm_pemilik }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Kode Aset</th>
                                                                    <td>{{ $kebudayaan->kode_aset }}<br />
                                                                        <b>{{ $kebudayaan->nm_aset5 }}</b>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">No Register</th>
                                                                    <td>{{ $kebudayaan->no_register }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Tgl Pembelian</th>
                                                                    <td>{{ $kebudayaan->tgl_perolehan }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Tgl Pembukuan</th>
                                                                    <td>{{ $kebudayaan->tgl_pembukuan }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Dokumen Tgl</th>
                                                                    <td>{{ $kebudayaan->dokumen_tanggal }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Beton/Tidak</th>
                                                                    <td>{{ $kebudayaan->beton_tidak }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Bertingkat/Tidak</th>
                                                                    <td>{{ $kebudayaan->bertingkat_tidak }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Luas Lantai</th>
                                                                    <td>{{ $kebudayaan->luas_lantai }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Alamat</th>
                                                                    <td>{{ $kebudayaan->lokasi }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Asal Usul</th>
                                                                    <td>{{ $kebudayaan->asal_usul }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Harga</th>
                                                                    <td>{{ $kebudayaan->harga }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Keterangan</th>
                                                                    <td>{{ $kebudayaan->keterangan }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                            ...
                                                            <tbody>
                                                                @foreach ($dokumen as $dt)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $dt->filename }}</td>
                                                                        <td>
                                                                            <a href="{{ route('kebudayaan.dokumen.download', $dt->id_dokumen) }} "
                                                                                id="{{ $dt->id_dokumen }}"
                                                        ...
                                                        <table class="table table-striped nowrap">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $kebudayaan->latitude }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Longitude</th>
                                                                    <td>{{ $kebudayaan->longitude }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#dttable').DataTable({
                    ...
                    bFilter: false,
                    ajax: {
                        url: "{{ url('admin/master-data/barang/intra/kebudayaan/json') }}",
            ...
            $('#mapLatLong').ready(() => {
                require([
                    ...
                    // var point = { type: "point", longitude: {{ $kebudayaan->latitude }}, latitude: {{ $kebudayaan->longitude }} }; 
                    ...
                    const view = new MapView({
                        ...
                        map: map,
                        center: [{{ $kebudayaan->longitude }}, {{ $kebudayaan->latitude }}],
                        zoom: 16,
                    });

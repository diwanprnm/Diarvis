                                                                ...
                                                                <div class="media-body row">
                                                                    <div class="col-lg-12">
                                                                        <div class="user-title">
                                                                            <h2>{{$atl->nm_aset5}}</h2>
                                                                            {{-- <span class="text-white">{{$atl->alamat}}</span> --}}
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                                            ...
                                                                                            <table class="table table-striped   nowrap">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>{{$atl->no_register}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Tgl Pembelian</th>
                                                                                                        <td>{{$atl->tgl_perolehan}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Tgl Pembukuan</th>
                                                                                                        <td>{{$atl->tgl_pembukuan}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                            ...
                                                                                            <table class="table table-striped   nowrap">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td> {{$atl->masa_manfaat}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th scope="row">Nilai Sisa</th>
                                                                                                        <td>{{$atl->nilai_sisa}}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <th scope="row">Tanggal Proses</th>
                                                                                                        <td>{{$atl->tgl_proses}}</td>
                                                                                                    </tr>
                                                                                                    <tr>

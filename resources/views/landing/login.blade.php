...
<head>
    ...
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendor/login/bootstrap/css/bootstrap.min.css') }}">
    <!-- themify-icons line icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendor/login/themify-icons/themify-icons.css') }}">
    <!-- ico font -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendor/login/icofont/css/icofont.css') }}">
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendor/login/style.css') }}">
</head>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        @endif
                         <form class="md-float-material form-material" id="login" action="{{ url('auth') }}" method="POST">
                            @csrf
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{ asset('assets/vendor/login/js/common-pages.js') }}"></script>

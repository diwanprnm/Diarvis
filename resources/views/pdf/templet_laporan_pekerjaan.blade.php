...
<body>
    <page size="A4">
        ...
        <br>
        <div class="row ml-4">
            <table id="table_judul" class=" col-9 pl-4">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> <input name="tanggal" type="text"
                                value="{{ @$data->km_dari }} s.d {{ @$data->km_ke }}" class="dotted" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>KABUPATEN/KOTA
                        ...
                        <td><input name="tanggal" type="text" value="{{ @$data->kab_kota }}" class="dotted" readonly>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table id="table_judul" class="col-3">
                <tbody>
                    <tr>
                        ...
                        <td><input name="tanggal" type="text"
                                value="{{ @$data->hal_dari }} dan {{ @$data->hal_ke }}"
                                class="dotted col-8 no_right_pad " readonly>
                        </td>
                        <td></td>
                    </tr>
                </tbody>

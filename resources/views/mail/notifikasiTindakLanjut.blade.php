        ...
        <thead>
          ...
          <tr>
            <th style="text-align:left;">
              ...
              <h1 style="color:#4d90fe;"> {{$data['disposisi_code'] ?? ""}}</h1>
            </th>
        ...
        <tbody>
          <tr>
            ...
            <p style="font-size:14px;margin:0 0 6px 0;"><span style="display:inline-block;min-width:110px">Pengirim</span>
              ...
              <p style="font-size:14px;margin:0 0 6px 0;"><span style="display:inline-block;min-width:110px">Tindak Lanjut</span>
              <b style="color:#4d90fe;font-weight:normal;margin:0">:  {{$data['tindak_lanjut'] ?? ""}} </b></p>
